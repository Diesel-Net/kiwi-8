...
static inline void exec_00EE() {
    /* 0x00EE: returns from subroutine */
    chip8.sp--;
    chip8.PC = chip8.stack[chip8.sp];
}

static inline void exec_0NNN() {
...
static inline void exec_1NNN() {
    /* 0x1NNN: jumps to address NNN */
    chip8.PC = OP_NNN;
}

static inline void exec_2NNN() {
...
static inline void exec_3XNN() {
    /* 0x3XNN: skips the next instruction if VX equals NN */
    if (chip8.V[OP_X] == OP_NN) chip8.PC += 2;
}

static inline void exec_4XNN() {
    /* 0x4XNN: skips the next instruction if VX doesn't equal NN */
    if (chip8.V[OP_X] != OP_NN) chip8.PC += 2;
}

static inline void exec_5XY0() {
    /* 0x5XY0: skips the next instruction if VX equals VY */
    if (chip8.V[OP_X] == chip8.V[OP_Y]) chip8.PC += 2;
}

static inline void exec_6XNN() {
    /* 0x6XNN: sets VX to NN */
    chip8.V[OP_X] = OP_NN;
}

static inline void exec_7XNN() {
    /* 0x7XNN: adds NN to VX */
    chip8.V[OP_X] += OP_NN;
}

static inline void exec_8XY0() {
    /* 0x8XY0: sets VX to the value of VY */
    chip8.V[OP_X] = chip8.V[OP_Y];
}

static inline void exec_8XY1() {
    /* 0x8XY1: sets VX to VX or VY */
    chip8.V[OP_X] |= chip8.V[OP_Y];
    if (chip8.quirks.logic_vf_quirk) chip8.V[0xF] = 0;
}

static inline void exec_8XY2() {
    /* 0x8XY2: sets VX to VX and VY */
    chip8.V[OP_X] &= chip8.V[OP_Y];
    if (chip8.quirks.logic_vf_quirk) chip8.V[0xF] = 0;
}

static inline void exec_8XY3() {
    /* 0x8XY3: sets VX to VX xor VY */
    chip8.V[OP_X] ^= chip8.V[OP_Y];
    if (chip8.quirks.logic_vf_quirk) chip8.V[0xF] = 0;
}

static inline void exec_8XY4() {
...
static inline void exec_FX15() {
    /* FX15: sets the delay timer to VX */
    chip8.delay_timer = chip8.V[OP_X];
}

static inline void exec_FX18() {
    /* FX18: sets the sound timer to VX */
    chip8.sound_timer = chip8.V[OP_X];
}

static inline void exec_FX1E() {
    /* FX1E: adds VX to I
...
static inline void exec_FX29() {
    /* FX29: sets I to the location of the sprite for the character in VX.
       Characters 0-F (in hexadecimal) are represented by a 4x5 font. */
    chip8.I = chip8.V[OP_X] * 0x05;
}

static inline void exec_FX33() {
...
static inline void exec_unknown() {
